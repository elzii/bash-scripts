...
echo ""
echo -e "\033[1;30m-------------------------------------------------------------------------------\033[37m"
echo -e "\033[1;30mCONFIG >> created directory ~/$COMPKGTMPDIR \033[37m"
echo -e "\033[1;30m-------------------------------------------------------------------------------\033[37m"
...
compkg_curl () {
	echo -e "storing cURL results into \033[1;30m$COMPKGTMPFILE\033[37m ... "
	echo -e "\033[1;30m-------------------------------------------------------------------------------\033[37m"
...
compkg_clean () {
	echo -ne "\033[1;30mcleaning up $COMPKGTMPDIRPATH/$COMPKGTMPFILE ... \033[32mCOMPLETE\033[37m"
